...
function renderRow() {
    return render(_jsxs(HorizontalRow, { title: "Test Shelf", children: [_jsx("div", { children: "Card 1" }), _jsx("div", { children: "Card 2" })] }));
}
...
//# sourceMappingURL=HorizontalRow.test.js.map