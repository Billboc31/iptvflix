...
export default function PlayerControls({ neverStopMode = false, onNeverStopToggle, neverStopSaving = false, videoRef, alternatives, onVariantSwitch, onClose, currentVariantId, audioTracks = [], currentAudioTrack = 0, onAudioTrack, subtitleTracks = [], currentSubtitleTrack = null, onSubtitleTrack, episodeLabel, nextEpisode, onNextEpisode, markers = [], deliveryMode, containerExtension, hintDurationSeconds = null, onStableDuration, }) {
