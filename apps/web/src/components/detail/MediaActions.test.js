...
function renderActions(props = {}) {
    return render(_jsx(ProfileProvider, { children: _jsx(MemoryRouter, { children: _jsx(MediaActions, { mediaType: "MOVIE", mediaId: "movie-1", availabilityStatus: "AVAILABLE", ...props }) }) }));
}
