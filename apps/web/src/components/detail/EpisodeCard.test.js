...
function renderCard(episode = BASE_EPISODE) {
    return render(_jsx(MemoryRouter, { children: _jsx(EpisodeCard, { episode: episode }) }));
}
describe('EpisodeCard', () => {
    ...
    it('labels play as Reprendre when progress is past 30 seconds', () => {
        render(_jsx(MemoryRouter, { children: _jsx(EpisodeCard, { episode: BASE_EPISODE, progressMs: 45_000 }) }));
