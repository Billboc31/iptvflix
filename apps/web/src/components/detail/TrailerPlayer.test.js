...
describe('TrailerPlayer', () => {
    it('renders nothing when trailerKey is null', () => {
        const { container } = render(_jsx(TrailerPlayer, { trailerKey: null, title: "Test Movie" }));
        expect(container.firstChild).toBeNull();
    });
    it('renders play button when trailerKey is provided, no iframe initially', () => {
        render(_jsx(TrailerPlayer, { trailerKey: "abc123", title: "Test Movie" }));
...
//# sourceMappingURL=TrailerPlayer.test.js.map