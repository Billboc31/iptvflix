...
export default function DeviceSettingsPage() {
    ...
    async function pairCode(rawCode, fromQr = false) {
    ...
    useEffect(() => {
        if (!codeFromUrl || isLoading || qrAutoTried.current)
            return;
