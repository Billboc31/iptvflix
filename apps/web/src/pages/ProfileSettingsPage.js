...
export default function ProfileSettingsPage() {
    ...
    return (_jsxs("div", { className: "max-w-xl mx-auto px-6 py-8", children: [currentProfile && (_jsxs("p", { className: "text-xs font-medium text-[#e50914] uppercase tracking-widest mb-1", children: ["Pr\u00E9f\u00E9rences du profil \u2014 ", currentProfile.name] })), _jsx("h1", { className: "text-2xl font-bold text-white mb-2", children: "Pr\u00E9f\u00E9rences de lecture" }), _jsx("p", { className: "text-gray-400 text-sm mb-4", children: "Ces pr\u00E9f\u00E9rences sont ind\u00E9pendantes de la langue de l'interface." }), _jsxs("div", { className: "mb-8 p-4 bg-white/5 border border-white/10 rounded-lg flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-white", children: "Appareils TV" }), _jsx("p", { className: "text-xs text-gray-400", children: "G\u00E9rer les appareils appair\u00E9s et lancer la lecture sur TV" })] }), _jsx(Link, { to: "/settings/devices", className: "text-sm text-[#e50914] hover:text-[#e50914]/80 font-medium transition-colors", children: "G\u00E9rer \u2192" })] }), _jsxs("form", { onSubmit: handleSave, children: [_jsx(LanguageListInput, { label: "Langues audio pr\u00E9f\u00E9r\u00E9es (ordre de priorit\u00E9)", value: prefs.preferredAudioLanguages, onChange: (v) => setPrefs((p) => ({ ...p, preferredAudioLanguages: v })) }), _jsx(LanguageListInput, { label: "Langues de sous-titres pr\u00E9f\u00E9r\u00E9es (ordre de priorit\u00E9)", value: prefs.preferredSubtitleLanguages, onChange: (v) => setPrefs((p) => ({ ...p, preferredSubtitleLanguages: v })) }), _jsx(SourcePriorityInput, { sources: sources, value: prefs.preferredSourceIds, onChange: (v) => setPrefs((p) => ({ ...p, preferredSourceIds: v })) }), _jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium text-gray-300 mb-2", children: "Qualit\u00E9 vid\u00E9o maximale" }), _jsx("select", { value: prefs.maxVideoQuality ?? '', onChange: (e) => setPrefs((p) => ({
                                    ...p,
                                    maxVideoQuality: e.target.value === '' ? null : e.target.value,
                                })), className: "bg-white/5 border border-white/10 rounded px-3 py-1.5 text-sm text-white focus:outline-none focus:border-white/30", children: QUALITY_OPTIONS.map((opt) => (_jsx("option", { value: opt.value, className: "bg-[#111118]", children: opt.label }, opt.value))) })] }), _jsxs("div", { className: "mb-6", children: [_jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: prefs.autoplayPreviews, onChange: (e) => setPrefs((p) => ({ ...p, autoplayPreviews: e.target.checked })), className: "w-4 h-4 accent-[#e50914]" }), _jsx("span", { className: "text-sm font-medium text-gray-300", children: "Activer les aper\u00E7us automatiques" })] }), _jsx("p", { className: "text-xs text-gray-500 mt-1 ml-7", children: "Aper\u00E7u vid\u00E9o muet apr\u00E8s un court d\u00E9lai au survol ou \u00E0 la s\u00E9lection d'un contenu." })] }), _jsxs("fieldset", { className: "mb-6 space-y-3", children: [_jsx("legend", { className: "text-white font-medium mb-3", children: "Encha\u00EEnement des \u00E9pisodes" }), [
                            ...
                            ].map(([key, label]) => (_jsxs("label", { className: "flex items-center gap-3 text-sm text-gray-300", children: [_jsx("input", { type: "checkbox", checked: !!prefs[key], onChange: (e) => setPrefs((p) => ({ ...p, [key]: e.target.checked })) }), label] }, key))), _jsx("p", { className: "text-xs text-gray-400", children: "Les sauts automatiques utilisent uniquement les rep\u00E8res compatibles avec la vid\u00E9o. Les sc\u00E8nes apr\u00E8s le g\u00E9n\u00E9rique sont conserv\u00E9es. Sans rep\u00E8res fiables, l\u2019\u00E9pisode continue normalement." })] }), error && _jsx("p", { className: "text-red-400 text-sm mb-4", children: error }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Button, { type: "submit", disabled: saving, children: saving ? 'Sauvegarde…' : 'Enregistrer' }), saved && _jsx("span", { className: "text-green-400 text-sm", children: "Pr\u00E9f\u00E9rences sauvegard\u00E9es" })] })] })] }));
}
