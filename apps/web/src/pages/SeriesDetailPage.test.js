...
function renderPage(id = 'series-1') {
    return render(_jsx(ProfileProvider, { children: _jsx(MemoryRouter, { initialEntries: [`/series/${id}`], children: _jsx(Routes, { children: _jsx(Route, { path: "/series/:id", element: _jsx(SeriesDetailPage, {}) }) }) }) }));
}
