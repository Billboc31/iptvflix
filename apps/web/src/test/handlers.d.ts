...
export declare const MOCK_CONTINUE_WATCHING_EPISODE: ContinueWatchingItem;
...
export declare const MOCK_PROFILE_A: ProfileResponse;
export declare const MOCK_PROFILE_B: ProfileResponse;
export declare const MOCK_PROFILE_KIDS: ProfileResponse;
export declare const MOCK_SELECT_PROFILE_RESPONSE: SelectProfileResponse;
