import type { ArrivalItem, MovieResponse, MovieDetailResponse, SeriesResponse, GenreResponse, SeriesDetailResponse, EpisodeResponse, PaginatedList, MovieFilters, SeriesFilters, SearchResponse, DiscoverResponse, SourceResponse, CreateSourceBody, UpdateSourceBody, TestSourceResult, SyncRunResponse, TriggerSyncBody, WatchlistEntry, AddToWatchlistBody, WatchlistMediaType, ViewingProgressRow, UpsertProgressBody, ProgressMediaType, ContinueWatchingItem, ShelfSummaryResponse, ShelfResponse, CreateShelfBody, UpdateShelfBody, AddShelfMemberBody, ReorderShelfMembersBody, GenerateShelfBody, GenerateShelfResponse, ProfileResponse, UpdateProfilePreferencesBody, FeedbackItem, SetFeedbackBody, HomeResponse, LoginResponse, MeResponse, PlaybackResolveRequest, PlaybackSessionResponse, DeviceResponse, PairingCodeDetailResponse, PlaybackCommandRequest, PlaybackCommandResponse } from '@iptvflix/api-contracts';
