import { pgTable, text, uuid, integer, timestamp, real, jsonb, varchar, boolean, customType, uniqueIndex, primaryKey, doublePrecision, numeric, unique, index, } from 'drizzle-orm/pg-core';
...
export const mediaEmbeddings = pgTable('media_embeddings', {
    ...
    uniqueIndex('media_embeddings_media_model_idx_re').on(t.mediaId, t.mediaType, t.modelProvider, t.modelName),
]);
// ─── Shelf concepts ───────────────────────────────────────────────────────────
export const shelfConcepts = pgTable('shelf_concepts', {
...
export const profileMediaExposure = pgTable('profile_media_exposure', {
    profileId: uuid('profile_id').notNull(),
    mediaType: text('media_type').notNull(),
    mediaId: uuid('media_id').notNull(),
