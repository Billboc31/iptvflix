...
beforeAll(async () => {
    const batchDefs = [
        ...Array.from({ length: BATCH_A }, (_, i) => ({ id: crypto.randomUUID(), title: `T113_E2E_A${i}`, firstAirYear: 2020, originalLanguage: 'fr' })),
        ...Array.from({ length: BATCH_B }, (_, i) => ({ id: crypto.randomUUID(), title: `T113_E2E_B${i}`, firstAirYear: 2005, originalLanguage: 'en' })),
        ...Array.from({ length: BATCH_C }, (_, i) => ({ id: crypto.randomUUID(), title: `T113_E2E_C${i}`, firstAirYear: 2018, originalLanguage: undefined })),
    ];
...
//# sourceMappingURL=e2e-retrieval-pool.test.js.map