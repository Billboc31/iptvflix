...
function makeContext(profileId) {
    return {
        requestId: 'test-req',
...
const MOVIE_FR_1980 = { id: 'mov-fr-80', mediaType: 'movie', title: 'French 80s Thriller', year: 1982, similarity: 0.7 };
const MOVIE_EN_2010 = { id: 'mov-en-10', mediaType: 'movie', title: 'English 2010s Comedy', year: 2012, similarity: 0.65 };
const MOVIE_NEUTRAL = { id: 'mov-neutral', mediaType: 'movie', title: 'Neutral Drama', year: 2000, similarity: 0.6 };
const CANDIDATES = [MOVIE_FR_1980, MOVIE_EN_2010, MOVIE_NEUTRAL];
...
describe('ranking divergence', () => {
    ...
    it('profile data isolation: French film has higher languageAffinity for profile A than B', async () => {
        ...
        expect(frFilmA.scoreBreakdown.languageAffinity).toBeGreaterThan(frFilmB.scoreBreakdown.languageAffinity);
    });
});
//# sourceMappingURL=ranking-divergence.integration.js.map