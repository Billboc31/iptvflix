...
export const EMBEDDING_MODEL_PROVIDER = process.env.EMBEDDING_MODEL_PROVIDER ?? 'openai';
export const EMBEDDING_MODEL_NAME = process.env.EMBEDDING_MODEL_NAME ?? 'text-embedding-3-small';
