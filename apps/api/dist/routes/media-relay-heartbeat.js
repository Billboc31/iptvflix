...
export async function mediaRelayHeartbeatRoutes(app) {
    app.post('/internal/media-relay/heartbeat', async (request, reply) => {
...
//# sourceMappingURL=media-relay-heartbeat.js.map