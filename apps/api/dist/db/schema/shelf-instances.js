import { pgTable, uuid, text, integer, boolean, timestamp, jsonb, real, index, } from 'drizzle-orm/pg-core';
import { profiles } from './profiles.js';
import { shelfConcepts } from './shelf-concepts.js';
export const shelfInstances = pgTable('shelf_instances', {
...
export const shelfInstanceItems = pgTable('shelf_instance_items', {
    id: uuid('id').primaryKey().defaultRandom(),
