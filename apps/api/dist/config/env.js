...
export const WEB_SECRET = process.env.WEB_SECRET || undefined;
export const JWT_SECRET = jwtSecret;
export const AUTH_USERNAME = process.env.AUTH_USERNAME ?? 'admin';
export const AUTH_PASSWORD_HASH = authPasswordHash;
export const M3U_FETCH_TIMEOUT_MS = Number(process.env.M3U_FETCH_TIMEOUT_MS ?? 60000);
export const SYNC_SCHEDULER_ENABLED = process.env.SYNC_SCHEDULER_ENABLED !== undefined
...
export const CATALOG_BOOTSTRAP_MAX_PAGES_PER_FEED = Number(process.env.CATALOG_BOOTSTRAP_MAX_PAGES_PER_FEED ?? 50);
export const CATALOG_BOOTSTRAP_MAX_PAGES_TOP_RATED = Number(process.env.CATALOG_BOOTSTRAP_MAX_PAGES_TOP_RATED ?? 20);
export const CATALOG_BOOTSTRAP_MAX_PAGES_PER_GENRE = Number(process.env.CATALOG_BOOTSTRAP_MAX_PAGES_PER_GENRE ?? 20);
export const CATALOG_BOOTSTRAP_MAX_PAGES_FRENCH = Number(process.env.CATALOG_BOOTSTRAP_MAX_PAGES_FRENCH ?? 10);
export const CATALOG_BOOTSTRAP_MAX_PAGES_NOW_PLAYING = Number(process.env.CATALOG_BOOTSTRAP_MAX_PAGES_NOW_PLAYING ?? 10);
/** Minimum vote count for genre/discover deep-page quality gate (feed steps are exempt). */
export const CATALOG_BOOTSTRAP_QUALITY_MIN_VOTE_COUNT = Number(process.env.CATALOG_BOOTSTRAP_QUALITY_MIN_VOTE_COUNT ?? 50);
/** Minimum popularity score for genre/discover deep-page quality gate (feed steps are exempt). */
export const CATALOG_BOOTSTRAP_QUALITY_MIN_POPULARITY = Number(process.env.CATALOG_BOOTSTRAP_QUALITY_MIN_POPULARITY ?? 5.0);
/** Max pages per feed for the discovery candidate pool refresher. */
export const DISCOVERY_POOL_MAX_PAGES_PER_FEED = Number(process.env.DISCOVERY_POOL_MAX_PAGES_PER_FEED ?? 5);
export const CATALOG_BOOTSTRAP_GENRE_IDS_MOVIE = (process.env.CATALOG_BOOTSTRAP_GENRE_IDS_MOVIE ?? '28,35,18,27,878,12,14,10749')
    .split(',')
    .map(Number)
    .filter(Boolean);
export const CATALOG_BOOTSTRAP_GENRE_IDS_TV = (process.env.CATALOG_BOOTSTRAP_GENRE_IDS_TV ?? '18,35,10765,10759,80,9648')
    .split(',')
    .map(Number)
    .filter(Boolean);
export const CATALOG_REFRESH_ENABLED = process.env.CATALOG_REFRESH_ENABLED !== undefined
...
export const CATALOG_REFRESH_UPCOMING_STALE_HOURS = Number(process.env.CATALOG_REFRESH_UPCOMING_STALE_HOURS ?? 12);
export const CATALOG_REFRESH_RECENT_STALE_DAYS = Number(process.env.CATALOG_REFRESH_RECENT_STALE_DAYS ?? 3);
export const CATALOG_REFRESH_STABLE_STALE_DAYS = Number(process.env.CATALOG_REFRESH_STABLE_STALE_DAYS ?? 30);
export const CATALOG_REFRESH_DISCOVERY_MAX_PAGES = Number(process.env.CATALOG_REFRESH_DISCOVERY_MAX_PAGES ?? 5);
export const CATALOG_BOOTSTRAP_HIERARCHY_PRIORITY_COUNT = Number(process.env.CATALOG_BOOTSTRAP_HIERARCHY_PRIORITY_COUNT ?? 200);
/**
...
export const LLM_PLANNER_MODEL = process.env.LLM_PLANNER_MODEL ?? 'gpt-4o-mini';
...
export const INTRODB_BASE_URL = process.env.INTRODB_BASE_URL || undefined;
export const THEINTRODB_BASE_URL = process.env.THEINTRODB_BASE_URL || undefined;
