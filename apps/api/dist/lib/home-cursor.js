...
import { HOME_CURSOR_SECRET } from '../config/env.js';
...
function hmacPayload(payloadEncoded) {
    return createHmac('sha256', HOME_CURSOR_SECRET).update(payloadEncoded).digest();
}
...
//# sourceMappingURL=home-cursor.js.map